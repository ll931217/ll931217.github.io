    ...
    <Layout>
      <div className="max-w-4xl mx-auto">
        ...
        <p className="mb-8 text-tokyo-fg/90">
          Explore my open-source projects and personal work. Each project
        ...
        >
          <div className="flex items-center gap-2">
            <CollapsibleTrigger className="flex items-center gap-2 px-3 py-1.5 text-sm text-tokyo-comment hover:text-tokyo-fg rounded-md bg-tokyo-selection/20 hover:bg-tokyo-selection/40 transition-colors">
              <Filter size={16} />
